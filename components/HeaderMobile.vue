			...
			<li>
				<Accordion id="0" :open="data.accordionPages[0].open" @toggleAccordion="onAccordionClick">
					<template #visible="visibleProps">
						<nuxt-link to="" class="parent-link">Menu</nuxt-link>
					</template>
					<template #hidden>
						<div class="flex flex-col">
							...
							<nuxt-link class="child-link whitespace-nowrap" :external="true" to="/menu#bar">Bar &
								Lounge</nuxt-link>
							<nuxt-link class="child-link whitespace-nowrap" :external="true" to="/menu#happy-hour">Happy
								Hour</nuxt-link>
							<nuxt-link class="child-link whitespace-nowrap" :external="true"
								to="/menu#banquet">Banquets</nuxt-link>
							<nuxt-link class="child-link whitespace-nowrap" :external="true" to="/menu#music">Live
								Music</nuxt-link>
					...
					<template #hidden>
						<div class="flex flex-col">
							...
							<nuxt-link class="child-link whitespace-nowrap" :external="true" to="/gallery#food">Menu
								Items</nuxt-link>
							<nuxt-link class="child-link whitespace-nowrap" :external="true" to="/gallery#fun">Fun
								Times</nuxt-link>
