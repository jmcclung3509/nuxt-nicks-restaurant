<template>
	<section id="hero">
			...
			<div class="hero-container flex justify-center items-center h-[100vh] w-[100vw]">
				...
				<div
					class="outer-container flex justify-center items-center w-3/4 h-3/4 lg:h-3/5 lg:w-1/2 mx-auto">
					<div class="text-container flex flex-col justify-end items-center w-[80%]  mx-auto space-y-14">
						<h1
							class="text-4xl lg:text-5xl text-center animate__animated animate__zoomIn animate__delay-1s ">
							Welcome to Nick's Restaurant
						</h1>
						<p class="text-center lg:w-[80%] mx-auto">
							Specializing in fresh seafood and prime-cut steaks, the Gust family has been welcoming
							guests from all over
							the world since 1927. </p>
					<button class=" text-white font-bold py-4 px-8 border border-none rounded"><a href="/about">
 Our Story</a>
</button>
					</div>
				</div>
