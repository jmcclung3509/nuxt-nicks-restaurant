	...
	<section
		...
		<div
			...
			<p>
				...
				Unwind and bask in the serene atmosphere of Rockaway Beach's
				picturesque cove. It's no surprise that this enchanting location
				lured a man from thousands of miles away to call it his home.
			</p>
			<div class="mx-auto">
				<img
			...
			<p>
				...
				across the country and settled in San Francisco, where he found
				various jobs, including working in a vegetable store, as a
				jitney driver, and on the Ocean Shore Railroad. His work on the
				railroad eventually led him to the breathtaking Pacifica
				coastside.
			</p>
			<div class="mx-auto">
				<img
			...
			<p>
				...
				join him. Togethe, they built a house in Daly City and raised
				four children. In 1927, Karagianis purchased a property on the
				water's edge at Rockaway Beach, where he established a business
				selling sandwiches, peanuts, and candy to fishermen and
				beachgoers. Tragedy struck when his business burnt down, but he
				rebuilt it and continued serving visitors. Despite another fire,
				he persisted and made Rockaway Beach his family's home.
			</p>
			...
			<div class="mx-auto">
				<img
					...
					class="img-fluid"
					alt="nick celebrating with friend" />
			</div>
		</div>
	</section>
</template>
